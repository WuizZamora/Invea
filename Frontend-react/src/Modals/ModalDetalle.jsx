...
const ModalDetalle = ({ item, loading, error, onClose }) => {
  ...
  const opcionesSelect = {
    Asunto: [
      ...
      "REPOSICIÓN DE SELLOS DE CLAUSURA", "REPOSICIÓN DE SELLOS DE MEDIDAS CAUTELARES","SOLICITA INFORMACIÓN"
    ],
    Motivo: [
      "ATENCIÓN CIUDADANA", "AUDIENCIA CIUDADANA", "CASA POR CASA",
      "INTERNOS", "REMITE INFORMACIÓN", "MEDIOS DIGITALES", "OFICIALIA DE PARTES", "CARPETA DE INVESTIGACIÓN"
    ],
